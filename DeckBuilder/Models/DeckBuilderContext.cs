...
namespace DeckBuilder.Models
{
    public class DeckBuilderContext : DbContext
    {
		...
		public DbSet<DeckComment> DeckComments { get; set; }	// Deck Comments
		public DbSet<Sideboard> Sideboards { get; set; }		// Deck sideboard
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Sideboard>().HasKey(d => new { d.DeckId, d.CardId });
